...
### Community 12 - "solmq-conn.bash"
Cohesion: 0.29
Nodes (3): solmq-conn.bash script, _solmq_conn(), _solmq_conn_paths()
...
Cohesion: 0.07
Nodes (27): 10. `examples`, 11. Notes and gotchas, 1.1 Shell completion, 1. Running solmq-conn, 2. Quick start, 3. Commands, 4.1 Variable expansion (`${VAR}`), 4. The config file and workflow discovery (+19 more)
...
Cohesion: 0.29
Nodes (7): Build, Design notes, Release (CI), Shell completion, solmq-conn -- Development Guide, Testing, The spec generator (`solmq-conn-generator.html`)
...
Cohesion: 0.40
Nodes (5): completion, `solmq-conn completion bash`, `solmq-conn completion fish`, `solmq-conn completion powershell`, `solmq-conn completion zsh`

## Knowledge Gaps
- **123 isolated node(s):** `solmq-conn.bash script`, `github.com/solacecommunity/hafio-solace/connectors/ibmmq/solmq-conn`, `Model`, `NO_COLOR`, `graphify` (+118 more)
