...
func RenderRunScript(in Input) string {
	...
	w := &sw{}
	w.Line(0, "#!/bin/sh")
	w.Line(0, "# Generated by solmq-conn -- podman run script for the Solace PubSub+ Connector for IBM MQ.")
	w.Line(0, "set -eu")
	w.Line(0, "")
...
func RenderQuadlet(in Input) Unit {
	...
	inst := in.Instance
	w := &sw{}
	w.Line(0, "# Generated by solmq-conn -- podman quadlet unit for the Solace PubSub+ Connector for IBM MQ.")
