...
Cohesion: 0.25
Nodes (8): Command details, deploy, examples, help, `solmq-conn deploy docker [-e env.yaml]`, `solmq-conn deploy kubernetes [-e env.yaml]`, `solmq-conn deploy podman [-e env.yaml]`, validate
...
### Community 51 - "delete"
Cohesion: 0.50
Nodes (4): delete, `solmq-conn delete docker [-e env.yaml]`, `solmq-conn delete kubernetes [-e env.yaml]`, `solmq-conn delete podman [-e env.yaml]`
