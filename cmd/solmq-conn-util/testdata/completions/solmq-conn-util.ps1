...
Register-ArgumentCompleter -Native -CommandName @('solmq-conn-util', 'solmq-conn-util.exe') -ScriptBlock {
    ...
    $verbs = @(
        ...
        @{ Name = 'logs'; Desc = 'Print each instance log, where status says what but not why' }
