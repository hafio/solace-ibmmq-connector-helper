...
// solace.java.*, so this carries the same key set as a SolaceBinder --
// solace-defaults and the connection's own verbatim api-properties included,
// not only the tool-managed TLS keys. The two stay in
