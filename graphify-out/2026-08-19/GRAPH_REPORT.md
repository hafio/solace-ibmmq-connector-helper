# Graph Report - solace-ibmmq-connector-helper  (2026-08-19)

## Corpus Check
- 66 files · ~154,226 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1137 nodes · 3239 edges · 68 communities (56 shown, 12 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 518 edges (avg confidence: 0.8)
...
Cohesion: 0.18
Nodes (25): synthWorkflows(), Workflow, checkContainerTarget(), checkDocker(), checkDuplicateSources(), checkKeyAliasConflicts(), checkKube(), checkLibs() (+17 more)
...
### Community 3 - "main.go"
Cohesion: 0.10
Nodes (54): absPath(), absResolver(), actDocker(), actKubernetes(), actPodman(), actStatus(), allowCommandFlag(), collectFlagsAndDirs() (+46 more)

### Community 4 - "Defaults"
Cohesion: 0.17
...
### Community 5 - "gen.go"
Cohesion: 0.09
Nodes (60): podmanDeploy(), built, DockerPlan, File, mount, NamedDoc, PodmanOpts, SecretRef (+52 more)
...
### Community 10 - "Render"
Cohesion: 0.14
Nodes (28): configMapDoc(), deploymentDoc(), dirReader(), envWithKube(), itoa(), lineDiff(), loadSpecs(), mustRead() (+20 more)
...
Cohesion: 0.12
Nodes (49): dispatch(), captureStderr(), podmanEnv(), podmanEnvSudo(), TestAbsPath(), TestAllowCommandFlagBadValueExitsUsageError(), TestAllowCommandFlagRepeatableThreadsToRunner(), TestAutoCompleteDispatchPrintsScript() (+41 more)
...
Cohesion: 0.05
Nodes (79): confirmInstall(), podmanRemove(), printTargetReport(), runStatusOnTargets(), os.FileMode, canIVerb(), Docker(), execArgv() (+71 more)
...
### Community 59 - "run"
Cohesion: 0.13
Nodes (21): run(), captureStdout(), manyWorkflowsDir(), TestAllowCommandFlagRejectedOnGenerateAndValidate(), TestExamplesDefaultDir(), TestExamplesWriteSkipForceThenGenerate(), TestGenerateConfigEmitWriteError(), TestGenerateConfigStdoutAndFileMatch() (+13 more)
...
### Community 61 - "Kubernetes"
Cohesion: 0.09
Nodes (38): TestDockerRejectsUnsafeCommand(), TestDockerUnknownAction(), TestDockerUpAndDown(), TestKubernetesDeployApplyOnStdin(), TestKubernetesRejectsUnsafeCommand(), TestKubernetesRemoveUsesDeleteVerb(), TestKubernetesUnknownAction(), workflowsFromRaw() (+30 more)

### Community 62 - "TestDispatchHandlersMatchModel"
Cohesion: 0.47
Nodes (6): assertSameNameSet(), keySet(), nameSet(), TestDispatchHandlersMatchModel(), TestPlatformMapsCoverThreeNames(), V

### Community 63 - "auto-complete"
Cohesion: 0.40
...
Cohesion: 0.19
Nodes (22): testing.T, TestLeaderElectionEffectiveMode(), ParseEnv(), TestParseEnvEmpty(), TestParseEnvUnknownKeyIgnored(), TestParseEnvWrongScalarTypeErrors(), TestWorkflowsFromRawDefaultWhenAbsent(), TestWorkflowsFromRawDirOverride() (+14 more)

### Community 65 - "spec.go"
Cohesion: 0.47
Nodes (7): applyDest(), yaml.Node, nodePtr(), rawMQ, rawSide, rawSolace, rawWorkflow

### Community 68 - "SafeToken"
Cohesion: 0.15
...
- **Why does `Defaults` connect `Defaults` to `validate.go`, `.Run`, `SafeToken`, `gen.go`, `SolaceProps`, `Model`, `spec_test.go`, `Render`, `buildLeaderElection`, `consolidate.go`, `Build`, `Side`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `Build()` connect `Build` to `consolidate_extra_test.go`, `validate.go`, `Defaults`, `gen.go`, `SolaceProps`, `Model`, `buildLeaderElection`, `consolidate.go`, `consolidate_test.go`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `Kubernetes` connect `Kubernetes` to `validate.go`, `main.go`, `spec_test.go`, `Render`?**
...
- **Are the 37 inferred relationships involving `dispatch()` (e.g. with `TestAllowCommandFlagBadValueExitsUsageError()` and `TestAllowCommandFlagRepeatableThreadsToRunner()`) actually correct?**
